                    ...
                    <Col md={{ span: 10, offset: 1 }} >
                        ...
                        <Row>
                            ...
                            <Col md="8">
                                ...
                                <Button variant='success' className='float-end'><BsPencil /> Edit</Button>
                                <Button variant='secondary' className='float-end' style={{ marginRight: 5 }} onClick={() => { history("/pegawai") }}><BsArrowBarLeft />  Kembali</Button>
                            </Col>
                        </Row>
                    </Col>
                </Row>
